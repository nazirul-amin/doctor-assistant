                ...
                <div className="mx-auto max-w-lg">
                    ...
                    <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-3">
                        ...
                        <p className="text-sm text-blue-700">
                            Patients will be added to today's registration queue and can be processed in order. Each patient will receive a queue
                            number and can be called when ready for consultation.
                        </p>
                    </div>
